...
import { studentGetAllActionSuccess,levelGetAllActionSuccess, subjectGetAllActionSuccess, levelGetAllActionInit, subjectGetAllActionInit } from './primary.action';
